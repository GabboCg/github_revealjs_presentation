...
## <span style="color: #F00; font-size: 150%; font-family: 'Bangers', cursive; text-shadow: -1px 0 black, 0 2px black, 3px 0 black, 0 -1px black;">  GitHub { .center .white data-background="static/imgs/git_example_dif.png"}
