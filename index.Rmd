...
-  <span style="color: white; font-size: 70%; font-family: 'Bangers', cursive; text-shadow: -1px 0 black, 0 5px black, 3px 0 black, 0 -1px black;"> Tools `r emo::ji("arrow_right")` Proyects Options `r emo::ji("arrow_right")` Git/SVN `r emo::ji("arrow_right")` Version Control System `r emo::ji("arrow_right")`  Git 
